...
from .models.model import yolo_eval, yolo_body, tiny_yolo_body
...
class YOLO(object):
    _defaults = {
        ...
        # "anchors_path": "hand_detection/yolo3/model_data/tiny_yolo_anchor.txt",
        # "classes_path": "hand_detection/yolo3/model_data/classes.txt",
        "score" : 0.3,
        "iou" : 0.45,
    ...
    def detect_image(self, image):
        ...
        print(end - start)
        return img,len(out_boxes), out_boxes
